(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@veho-tech/error", [], factory);
	else if(typeof exports === 'object')
		exports["@veho-tech/error"] = factory();
	else
		root["@veho-tech/error"] = factory();
...
var freeGlobal = __webpack_require__(4);
...
function inherits(Child, Parent) {
    ...
    (0, _forEach2.default)(Parent, function (val, key) {
...
function makeErrorType(name, constructor) {
    var errorClass = function errorClass() {
        ...
        constructor.call.apply(constructor, [this].concat(args));
 ...
 */
var VehoError = exports.VehoError = makeErrorType('Error', function (error, reason, details) {
    var self = this;
...
var arrayEach = __webpack_require__(11),
    ...
    castFunction = __webpack_require__(38),
...
/* WEBPACK VAR INJECTION */(function(module) {var freeGlobal = __webpack_require__(4);
